#!/bin/bash
#SBATCH --job-name=hopper_medium_expert         # Job name
#SBATCH --output=hopper_medium_expert_%j.log    # Standard output and error log (%j creates a unique ID)
...
python sdt_hopper.py --env_name hopper-medium-expert-v2 --subgoal_interval $interval

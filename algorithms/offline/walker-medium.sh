#!/bin/bash
#SBATCH --job-name=walker2d_medium         # Job name
#SBATCH --output=walker2d_medium_%j.log    # Standard output and error log (%j creates a unique ID)
...
python sdt_walker.py --env_name walker2d-medium-v2 --subgoal_interval $interval

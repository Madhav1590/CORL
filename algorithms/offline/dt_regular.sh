...
#SBATCH --time=10:00:00                            # Set a maximum time limit (3 hours)
...
output_file="dt_${env}_${target_return}_$SLURM_JOB_ID.log"
...
python dt_regular.py --env_name $env --target_return $target_return

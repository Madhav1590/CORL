...
#SBATCH --output=final_hopper_me_%j.log    # Standard output and error log (%j creates a unique ID)
...
python final.py --env_name hopper-medium-expert-v2 --subgoal_interval=$interval

#!/bin/bash
#SBATCH --job-name=halfcheetah_medium_replay         # Job name
#SBATCH --output=halfcheetah_medium_replay_%j.log    # Standard output and error log (%j creates a unique ID)
...
python sdt_hc.py --env_name halfcheetah-medium-replay-v2 --subgoal_interval $interval
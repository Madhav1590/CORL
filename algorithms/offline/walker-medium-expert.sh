#!/bin/bash
#SBATCH --job-name=walker2d_medium_expert         # Job name
#SBATCH --output=walker2d_medium_expert_%j.log    # Standard output and error log (%j creates a unique ID)
...
python sdt_walker.py --env_name walker2d-medium-expert-v2 --subgoal_interval $interval
